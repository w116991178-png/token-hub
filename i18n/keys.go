...
const (
	...
	MsgUserAffiliateSubdomainRequired = "user.affiliate_subdomain_required"
	MsgUserAffiliateSubdomainInvalid  = "user.affiliate_subdomain_invalid"
	MsgUserAffiliateSubdomainReserved = "user.affiliate_subdomain_reserved"
	MsgUserAffiliateSubdomainInUse    = "user.affiliate_subdomain_in_use"
)
